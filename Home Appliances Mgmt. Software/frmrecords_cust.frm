...
Begin VB.Form frmrecords_cust 
   ...
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "frmrecords_cust.frx":0000
   ScaleHeight     =   7800
   ScaleWidth      =   10995
   ShowInTaskbar   =   0   'False
   Begin MSAdodcLib.Adodc adodcrecords_cust 
      Height          =   330
      Left            =   5040
      Top             =   120
      Visible         =   0   'False
   ...
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid MSHFlexGrid1 
      Bindings        =   "frmrecords_cust.frx":32D68
      Height          =   3855
      Left            =   960
      TabIndex        =   0
      Top             =   2640
   ...
   Begin VB.Image Image2 
      Height          =   1335
      Left            =   1200
      Picture         =   "frmrecords_cust.frx":32D88
      Stretch         =   -1  'True
      Top             =   1320
      Width           =   1335
   End
   Begin VB.Image cmdmainmenu 
      Height          =   375
      Left            =   6600
      MouseIcon       =   "frmrecords_cust.frx":33AEF
      MousePointer    =   99  'Custom
      Picture         =   "frmrecords_cust.frx":33DF9
      Stretch         =   -1  'True
   ...
   Begin VB.Image cmdback 
      Height          =   375
      Left            =   3960
      MouseIcon       =   "frmrecords_cust.frx":348C3
      MousePointer    =   99  'Custom
      Picture         =   "frmrecords_cust.frx":34BCD
      Stretch         =   -1  'True
      ToolTipText     =   "Back"
      Top             =   6480
      Width           =   495
   ...
   Begin VB.Image Image1 
      Height          =   1095
      Left            =   960
      Picture         =   "frmrecords_cust.frx":35641
      Stretch         =   -1  'True
      Top             =   960
      Width           =   9135
   End
End
Attribute VB_Name = "frmrecords_cust"
